...
function t(n) {
  ...
  var s = c.appendChild.bind(c);
  return i.map(t).map(s), c;
}
...
function n(t, r, o, i) {
  ...
  if (r)
    if (e.isString(t) && e.isString(r))
      ...
      Object.keys(s).length && c.push({ type: 'PROPS', props: s }),
        (function (t, r, o, i, c) {
          ...
          console.log(s),
            s.moves.length && c.push({ type: 'ORDER', moves: s.moves });
          r = s.nodes;
          for (var a = 0; a < t.length || a < r.length; a++) {
            n(t[a], r[a], a + ++o, i);
          }
